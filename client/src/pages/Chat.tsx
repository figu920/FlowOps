...
export default function Chat() {
  ...
  return (
    <Layout title="Team Chat" className="p-0 overflow-hidden">
      
      {/* CREAMOS UN CONTENEDOR MANUAL PARA CONTROLAR LA ALTURA EXACTA */}
      {/* h-[85vh] es una medida segura. Si queda muy corto, subelo a 90vh */}
      <div className="flex flex-col h-[85vh] w-full relative bg-[#121212]">

        {/* AREA DE MENSAJES (Ocupa todo el espacio disponible con flex-1) */}
        <div 
          ref={scrollRef}
          className="flex-1 overflow-y-auto px-4 pb-4 pt-4 space-y-6 w-full"
        >
          {chat.map((msg, i) => {
        ...
        {/* AREA DE INPUT (Fija abajo gracias al flex container) */}
        <div className="shrink-0 bg-[#161618] border-t border-white/10 pb-6 pt-3 px-4 w-full z-50 shadow-2xl">
